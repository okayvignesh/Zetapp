        ...
        <section className='products'>
            <div className="container">
                ...
                <div data-aos="fade-up" className="row my-5">
                    <div className="col-lg-6 product-card one">
                    ...
                    <div className="col-lg-6 product-card two">
                    ...
                    <div className="col-lg-6 product-card three">
                    ...
                    <div className="col-lg-6 product-card four">
